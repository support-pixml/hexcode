...
class __TwigTemplate_20481fb3ca77259cff04f7ece69262aaca5332703d86336f6533640e9b62bff9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 808
            echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 808);
            echo " (";
            echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 808);
            echo ")
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 809
            if (($context["option"] ?? null)) {
                ...
                echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 810));
                foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                    // line 811
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t- ";
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 811);
                    echo " ";
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "value", [], "any", false, false, false, 811);
                    echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                }
                $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 821
            echo twig_get_attribute($this->env, $this->source, $context["product"], "total", [], "any", false, false, false, 821);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 920
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 920);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding:5px 0;Margin:0\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\twidth=\"20%\"
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 927
            echo twig_get_attribute($this->env, $this->source, $context["total"], "value", [], "any", false, false, false, 927);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
...
\t</div>
    ...
    {
        return array (  1254 => 1028,  1247 => 1024,  1236 => 1016,  1229 => 1011,  1227 => 1010,  1146 => 931,  1136 => 927,  1126 => 920,  1113 => 912,  1065 => 867,  1020 => 824,  1010 => 821,  998 => 813,  987 => 811,  982 => 810,  980 => 809,  974 => 808,  965 => 801,  961 => 800,  913 => 755,  850 => 695,  839 => 687,  826 => 677,  815 => 669,  802 => 659,  792 => 652,  719 => 582,  570 => 436,  165 => 33,  160 => 32,  155 => 30,  153 => 29,  149 => 27,  139 => 26,  135 => 25,  130 => 23,  126 => 21,  115 => 20,  111 => 19,  108 => 18,  106 => 17,  103 => 16,  87 => 13,  83 => 12,  81 => 11,  71 => 10,  67 => 9,  62 => 7,  55 => 5,  49 => 4,  43 => 3,  37 => 1,);
    }
