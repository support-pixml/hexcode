...
class __TwigTemplate_0c20a1b3b1977601a86b9a66e783dcea67e1b26b962ad0af58af20ec792754c8 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">";
    ...
    ";
      ...
      <table class=\"table table-bordered\">
        ...
        // line 62
        echo twig_get_attribute($this->env, $this->source, ($context["total"] ?? null), "title", [], "any", false, false, false, 62);
        echo ":</strong></td>
          <td class=\"text-right\">&#8377; ";
        // line 63
        echo twig_get_attribute($this->env, $this->source, ($context["total"] ?? null), "value", [], "any", false, false, false, 63);
        echo "</td>
        </tr>
        </tfoot>
      </table>
