...
class __TwigTemplate_eff07157ac887dca2dc3f2ab2903f7d1ee9e7f7dc93f33ce510a1c53b2495112 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"section-body\">
    ...
    <div v-if=\"!customer_id || (customer_id && (";
      ...
      <div class=\"form-group required account-firstname\"  v-if=\"customer_id || (!customer_id && '";
        // line 38
        echo ($context["type"] ?? null);
        echo "' !== 'shipping')\" style=\"width:48%;float:left; margin-right:2px;\">
