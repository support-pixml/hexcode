...
class __TwigTemplate_aa15b338d0d511c47a5077197d4132f015059537d98679253c299b19e9aa7a08 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"section-body\">
    ...
    <div v-if=\"!customer_id || (customer_id && (";
      ...
      <div class=\"form-group required account-firstname\"  v-if=\"customer_id || (!customer_id && '";
        // line 38
        echo ($context["type"] ?? null);
        echo "' !== 'shipping')\" style=\"width:48%;float:left; margin-right:10px;\">
