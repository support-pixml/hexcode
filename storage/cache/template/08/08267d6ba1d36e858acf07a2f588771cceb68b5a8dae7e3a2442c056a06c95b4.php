...
class __TwigTemplate_184f48a51a61d811343213685b8a9680c8d885a30c7b98f9aeedccb2c6ca5009 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <table class=\"table table-bordered\">
        ...
        <tr v-for=\"total in order_totals\">
          ...
          <td class=\"text-right\" v-html=\"total.text\" v-bind:class = \"(total.title == 'Total')?'color-success price-bold':''\"></td>
        </tr>
        </tfoot>
      </table>
