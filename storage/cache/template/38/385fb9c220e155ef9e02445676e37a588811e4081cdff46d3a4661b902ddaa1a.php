...
class __TwigTemplate_070c09793962a46a438b646c56a311376b490963b4364ee916baafe32b1c5f95 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <table class=\"table table-bordered\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            // line 60
            echo "        <tfoot v-if=\"order_totals.length\">
        <tr v-for=\"total in order_totals\">
          <td colspan=\"7\" class=\"\"><span v-html=\"total.title + ''\"></span></td>
          <td class=\"text-right\" v-html=\"total.value\" v-bind:class = \"(total.title == 'Total')?'color-success price-bold':''\"></td>
        </tr>
        ";
        }
        $_parent = $context['_parent'];
      ...
      <div class=\"cart-total table-responsive\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            ...
            echo ":</strong></td>
                <td class=\"text-right\">";
            // line 73
            echo twig_get_attribute($this->env, $this->source, $context["total"], "value", [], "any", false, false, false, 73);
            echo "</td>
              </tr>
            ";
        }
