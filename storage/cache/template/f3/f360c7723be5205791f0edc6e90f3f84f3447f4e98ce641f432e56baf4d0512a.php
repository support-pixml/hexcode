...
class __TwigTemplate_c99d1247b609da1c60de1d8b19bc3810c52cfca5586920cfacb490a0d99a3f7a extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    <div id=\"content\">
      <h1 class=\"title\"><img src=\"";
        ...
        echo "\" ";
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 19), "get", [0 => "logo2x_src"], "method", false, false, false, 19)) {
            echo "srcset=\"";
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 19), "get", [0 => "logo_src"], "method", false, false, false, 19);
            echo " 1x, ";
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 19), "get", [0 => "logo2x_src"], "method", false, false, false, 19);
            echo " 2x\"";
        }
        echo " width=\"";
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 19), "get", [0 => "logo_width"], "method", false, false, false, 19);
        echo "\" height=\"";
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 19), "get", [0 => "logo_height"], "method", false, false, false, 19);
        echo "\" alt=\"";
...
";
    ...
    {
        return array (  210 => 73,  206 => 72,  198 => 67,  187 => 59,  181 => 56,  176 => 54,  170 => 51,  165 => 49,  155 => 42,  150 => 40,  145 => 38,  140 => 36,  131 => 30,  127 => 29,  117 => 23,  111 => 21,  109 => 20,  89 => 19,  83 => 17,  75 => 13,  73 => 12,  68 => 10,  62 => 8,  60 => 7,  57 => 6,  46 => 4,  42 => 3,  37 => 1,);
    }
