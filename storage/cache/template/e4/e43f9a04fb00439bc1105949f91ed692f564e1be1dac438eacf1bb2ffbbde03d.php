...
class __TwigTemplate_6588034bc50df34c967391c596515d4d797423edd5a0506087d39a696a1f0559 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            ...
            echo " x ";
            echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 818);
            echo "
                                                      ";
            // line 819
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 819));
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                echo "<br />
                                                      &nbsp;<small> - ";
                // line 820
                echo twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 820);
                echo ": ";
                echo twig_get_attribute($this->env, $this->source, $context["option"], "value", [], "any", false, false, false, 820);
                echo "</small>
                                                      ";
            }
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 829
            echo twig_get_attribute($this->env, $this->source, $context["product"], "total", [], "any", false, false, false, 829);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
                                                </tr>
                                                ";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 877
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 877);
            echo ":
                                                    </p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding:5px 0;Margin:0\"
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 885
            echo twig_get_attribute($this->env, $this->source, $context["total"], "text", [], "any", false, false, false, 885);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
                                                </tr>
                                                ";
...
\t</div>
    ...
    {
        return array (  1160 => 999,  1048 => 889,  1038 => 885,  1027 => 877,  1018 => 870,  1014 => 869,  976 => 833,  966 => 829,  957 => 822,  947 => 820,  941 => 819,  935 => 818,  926 => 811,  922 => 810,  880 => 771,  871 => 765,  824 => 720,  805 => 704,  756 => 658,  724 => 628,  722 => 627,  704 => 612,  698 => 609,  686 => 600,  680 => 597,  673 => 593,  667 => 590,  619 => 545,  564 => 492,  554 => 485,  543 => 477,  536 => 472,  533 => 471,  523 => 464,  512 => 456,  505 => 451,  503 => 450,  497 => 447,  422 => 381,  52 => 14,  37 => 1,);
    }
