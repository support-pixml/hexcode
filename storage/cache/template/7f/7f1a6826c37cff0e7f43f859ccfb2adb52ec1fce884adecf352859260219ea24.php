...
class __TwigTemplate_b14f11435a000dd414d1ec56c2a4f3964271516266670b97ade7eba65f62fe37 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"title section-title\">Price Details</div>
      <table class=\"table table-bordered\">
        ...
        <tr v-for=\"total in totals\">
          ...
          <td class=\"text-right\" v-html=\"total.text\" v-bind:class = \"(total.title == 'Total')?'color-success':''\"></td>
        </tr>
        </tfoot>
      </table>
  </div>
