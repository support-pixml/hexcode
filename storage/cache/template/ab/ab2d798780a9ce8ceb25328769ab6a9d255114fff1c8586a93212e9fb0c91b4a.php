...
class __TwigTemplate_92752deb237a420120d12bafecd8acf4e9eb71ad9421975e67da22eae17d8000 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"title section-title\" style=\"padding-top: 15px;\">Price Details</div>
      <table class=\"table table-bordered\">
        ...
        <tr v-for=\"total in totals\">
          ...
          ";
        // line 81
        if ((twig_get_attribute($this->env, $this->source, ($context["total"] ?? null), "title", [], "any", false, false, false, 81) != "Total")) {
            // line 82
