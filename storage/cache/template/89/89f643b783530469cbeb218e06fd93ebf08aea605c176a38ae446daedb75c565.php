...
class __TwigTemplate_5c01003e9a4c348f8c9bd723f24d8ce23e2dd674abff70d3a78dd17551107642 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"title section-title\" style=\"padding-top: 15px;\">Price Details</div>
      <table class=\"table table-bordered\">
        ...
        <tr v-for=\"total in totals\">
          ...
          ";
        // line 81
        if ((twig_get_attribute($this->env, $this->source, ($context["total"] ?? null), "title", [], "any", false, false, false, 81) != ($context["Total"] ?? null))) {
            // line 82
            echo "          <td class=\"text-right\" v-html=\"total.text\"></td>
          ";
        } else {
            // line 84
            echo "          <td class=\"text-right\"><strong v-html=\"total.text\"></strong>";
            echo twig_get_attribute($this->env, $this->source, ($context["total"] ?? null), "title", [], "any", false, false, false, 84);
            echo "</td>
          ";
        }
        // line 86
...
";
    ...
    {
        return array (  167 => 86,  161 => 84,  157 => 82,  155 => 81,  138 => 67,  120 => 52,  116 => 51,  99 => 37,  75 => 16,  71 => 15,  67 => 14,  63 => 13,  59 => 12,  55 => 11,  45 => 4,  40 => 2,  37 => 1,);
    }
