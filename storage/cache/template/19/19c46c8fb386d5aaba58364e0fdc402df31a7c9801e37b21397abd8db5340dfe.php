...
class __TwigTemplate_17f8ad4cb0a9a476930d5b303ae05a6483ed5d362b12ac0afe60ca8d80084389 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"section-body\">
    ...
    <div v-if=\"!customer_id || (customer_id && (";
      ...
      <div class=\"form-group required account-firstname\"  v-if=\"customer_id || (!customer_id && '";
        // line 38
        echo ($context["type"] ?? null);
        echo "' !== 'shipping')\" style=\"width:48%;float:left; margin-right:15px;\">
