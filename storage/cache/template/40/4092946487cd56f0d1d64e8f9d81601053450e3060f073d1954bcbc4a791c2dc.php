...
class __TwigTemplate_693cf7524200c73f1a11f1a6a257fb84a2e1e7022fdb32b140b6b8428cbac2f6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\talign=\"center\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"padding:0;Margin:0;align-content: center;\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<table width=\"100%\" cellspacing=\"0\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tcellpadding=\"0\" role=\"presentation\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tbody>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 1080
            echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 1080);
            echo " x ";
            echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 1080);
            echo "
                                                      ";
            // line 1081
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 1081));
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                ...
                echo ": ";
                echo twig_get_attribute($this->env, $this->source, $context["option"], "value", [], "any", false, false, false, 1082);
                echo "</small>
                                                      ";
            }
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 1091
            echo twig_get_attribute($this->env, $this->source, $context["product"], "total", [], "any", false, false, false, 1091);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
                                                </tr>
                                                ";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 1139
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 1139);
            echo ":
                                                    </p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"padding:5px 0;Margin:0\"
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 1147
            echo twig_get_attribute($this->env, $this->source, $context["total"], "text", [], "any", false, false, false, 1147);
            echo ":</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
                                                </tr>
                                                ";
...
\t</div>
    ...
    {
        return array (  1462 => 1261,  1350 => 1151,  1340 => 1147,  1329 => 1139,  1320 => 1132,  1316 => 1131,  1278 => 1095,  1268 => 1091,  1259 => 1084,  1249 => 1082,  1243 => 1081,  1237 => 1080,  1228 => 1073,  1224 => 1072,  1182 => 1033,  1173 => 1027,  1123 => 979,  1110 => 969,  1098 => 960,  1080 => 944,  1078 => 943,  1065 => 933,  1054 => 925,  1032 => 905,  1013 => 889,  964 => 843,  932 => 813,  930 => 812,  912 => 797,  901 => 789,  888 => 779,  878 => 772,  865 => 762,  855 => 755,  822 => 724,  815 => 720,  804 => 712,  795 => 705,  793 => 704,  787 => 701,  777 => 694,  764 => 684,  754 => 677,  705 => 631,  650 => 578,  640 => 571,  629 => 563,  622 => 558,  619 => 557,  609 => 550,  598 => 542,  591 => 537,  589 => 536,  583 => 533,  422 => 381,  52 => 14,  37 => 1,);
    }
