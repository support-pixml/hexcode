...
class __TwigTemplate_213bd665eba17eb990a530aa1f8b951428fe01caa4d79da3b11618c7b5f27dbe extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"section-body\">
    ...
    <div class=\"form-group required account-email\">
      ...
      <input v-model=\"order_data.email\" type=\"text\" name=\"email\" value=\"\" placeholder=\"";
        // line 35
        echo ($context["entry_email"] ?? null);
        echo "\" id=\"input-email\" class=\"form-control\" v-bind:class = \"(error && error.email)?'has-error':''\"/>
    ...
    <div v-if=\"account === 'register'\" class=\"form-group required account-pass\">
      ...
      <input v-model=\"password\" type=\"password\" name=\"password\" value=\"\" placeholder=\"";
        // line 51
        echo ($context["entry_password"] ?? null);
        echo "\" id=\"input-password\" class=\"form-control\" v-bind:class = \"(error && error.password)?'has-error':''\"/>
    ...
    <div v-if=\"account === 'register'\" class=\"form-group required account-pass2\">
      ...
      <input v-model=\"password2\" type=\"password\" name=\"confirm\" value=\"\" placeholder=\"";
        // line 57
        echo ($context["entry_confirm"] ?? null);
        echo "\" id=\"input-confirm\" class=\"form-control\" v-bind:class = \"(error && error.password2)?'has-error':''\"/>
