...
class __TwigTemplate_1ecc02b2e02548ff6a1ad682492dc8c7365c90969f1665da2296da63ff102812 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t  html += '\t</div>';
      ...
      if (item['type'] == 'checkbox') {
        html += '<div class=\"form-group\">';
        html += '<label class=\"col-sm-2 control-label\" for=\"input-checkboxmaxchecks' + option_row + '\">Customer needs to check how many options? (0 = no limit)</label>';
        html += '<div class=\"col-sm-10\"><input type=\"text\" name=\"product_option[' + option_row + '][checkboxmaxchecks]\" value=\"\" placeholder=\"0\" id=\"input-checkboxmaxchecks' + option_row + '\" class=\"form-control\" /></div>';
        html += '</div>';
      }
