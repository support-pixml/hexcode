...
class __TwigTemplate_0c51d850d196d7099778849458ffec9bc8117407c73ecabfe7d7a71fe7950ae4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 807
            echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 807);
            echo " (";
            echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 807);
            echo ")
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 808
            if (($context["option"] ?? null)) {
                ...
                echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 809));
                foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                    // line 810
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t- ";
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 810);
                    echo " ";
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "value", [], "any", false, false, false, 810);
                    echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                }
                $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 820
            echo twig_get_attribute($this->env, $this->source, $context["product"], "total", [], "any", false, false, false, 820);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 905
            echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 905);
            echo " (";
            echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 905);
            echo ")
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 906
            if (($context["option"] ?? null)) {
                ...
                echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 907));
                foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                    // line 908
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t- ";
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 908);
                    echo " ";
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "value", [], "any", false, false, false, 908);
                    echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                }
                $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 918
            echo twig_get_attribute($this->env, $this->source, $context["product"], "total", [], "any", false, false, false, 918);
            echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
...
\t</div>
    ...
    {
        return array (  1295 => 1056,  1288 => 1052,  1277 => 1044,  1270 => 1039,  1268 => 1038,  1149 => 921,  1139 => 918,  1127 => 910,  1116 => 908,  1111 => 907,  1109 => 906,  1103 => 905,  1094 => 898,  1090 => 897,  1014 => 823,  1004 => 820,  992 => 812,  981 => 810,  976 => 809,  974 => 808,  968 => 807,  959 => 800,  955 => 799,  907 => 754,  844 => 694,  833 => 686,  820 => 676,  809 => 668,  796 => 658,  786 => 651,  713 => 581,  164 => 34,  159 => 32,  154 => 30,  152 => 29,  148 => 27,  138 => 26,  134 => 25,  129 => 23,  125 => 21,  114 => 20,  110 => 19,  107 => 18,  105 => 17,  102 => 16,  86 => 13,  82 => 12,  80 => 11,  70 => 10,  66 => 9,  61 => 7,  54 => 5,  48 => 4,  42 => 3,  37 => 1,);
    }
