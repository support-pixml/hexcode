...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$replace = array(
				'firstname' => strtoupper($order_info['payment_firstname']),
				'lastname'  => strtoupper($order_info['payment_lastname']),
			...
			$replace = array(
				'firstname' => strtoupper($order_info['shipping_firstname']),
				'lastname'  => strtoupper($order_info['shipping_lastname']),
	...
	public function invoice() {
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$replace = array(
					'firstname' => '<b>'.strtoupper($order_info['payment_firstname']).'</b>',
					'lastname'  => '<b>'.strtoupper($order_info['payment_lastname']).'</b>',
					'company'   => $order_info['payment_company'],
					'address_1' => $order_info['payment_address_1'],
					'address_2' => $order_info['payment_address_2'],
					'city'      => $order_info['payment_city'],
				...
				$replace = array(
					'firstname' => '<b>'.strtoupper($order_info['shipping_firstname']).'</b>',
					'lastname'  => '<b>'.strtoupper($order_info['shipping_lastname']).'</b>',
					'company'   => $order_info['shipping_company'],
					'address_1' => $order_info['shipping_address_1'],
					'address_2' => $order_info['shipping_address_2'],
					'city'      => $order_info['shipping_city'],
				...
				foreach ($products as $product) {
					...
					if ($product_info) {
						...
						foreach ($options as $option) {
							...
							// echo '<pre>'; print_r($product_option_value_info); echo '</pre>';die;
